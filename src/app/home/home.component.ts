...
export class HomeComponent implements OnInit {
  ...
  private TIME_TO_WAIT_BETWEEN_ANIMATIONS = 5000;
  ...
  private changeToRandomPath() {
    ...
    //load new path
    var currentAnimation = anime({
      targets: "#path-to-animate", 
      d: [
        { value: this.svg[this.selectedSvg] }, 
      ], 
      easing: "linear", 
      duration: 5000, 
      autoplay: true, 
    ...
    // give new background to newBackgroundName
    // fade to color -> white the current background 
    // fade to white -> color the new background
    //set the currentBackground = newBackground
    //hide new Background
